...
autocmd FileType plaintex,tex call ModeTex()
	...
	iab item \begin{itemize}<CR>\end{itemize}<CR><Up><CR><Up>\item<CR>\item<Up>
	iab enum \begin{enumerate}<CR>\end{enumerate}<CR><Up><CR><Up>\item<CR>\item<Up>
...
"	iab $ $$<Left>
	...
	iab ex exists \,<Left><Left><Left>
	iab for forall \,<Left><Left><Left>
